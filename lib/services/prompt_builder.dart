...
3. **사실 정보**: 대화에서 공유된 객관적 사실 (발표, 출시, 수치, 날짜 등)
   - 반드시 누가 말했는지 출처를 표기
4. **의견 및 토론**: 참여자들의 주관적 견해, 찬반 논쟁, 추천 이유
   - "~라는 의견", "~주장" 등으로 사실과 명확히 구분
5. **AI 분석**: 위 내용을 바탕으로 당신의 종합 의견과 다음 스텝 추천
